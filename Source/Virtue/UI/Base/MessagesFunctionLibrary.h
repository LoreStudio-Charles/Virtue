...
public:
     ...
     /** Returns the localized text for the "Logout" message. */
     UFUNCTION(BlueprintPure, Category = "Config | Messages")
     ...
     /** Returns the localized title for the Options Menu. */
     UFUNCTION(BlueprintPure, Category = "Config | Messages")
     ...
     /** Returns the localized text for the "Hair" message. */
     UFUNCTION(BlueprintPure, Category = "Config | Messages")
     ...
     /** Returns the localized text for the "Arms" message. */
     UFUNCTION(BlueprintPure, Category = "Config | Messages")
     ...
     /** Returns the localized text for the "Legs" message. */
     UFUNCTION(BlueprintPure, Category = "Config | Messages")
     ...
     /** Returns the localized text for the "Accessories" message. */
     UFUNCTION(BlueprintPure, Category = "Config | Messages")
     ...
     /** Returns the localized text for the "Create" message in the Characters Transition Screen. */
     UFUNCTION(BlueprintPure, Category = "Config | Messages")
     static FText GetCTScreenCreateButtonText()
     {
          return FText::FromStringTable(*AssetPaths::UIStrings, TEXT("CTScreenCreateButtonText"));
     }

     /** Returns the localized text for the "Back" message in the Characters Transition Screen. */
     UFUNCTION(BlueprintPure, Category = "Config | Messages")
     static FText GetCTScreenBackButtonText()
     {
          return FText::FromStringTable(*AssetPaths::UIStrings, TEXT("CTScreenBackButtonText"));
     }

     /** Returns the localized text for the "Delete" message in the Characters Transition Screen. */
     UFUNCTION(BlueprintPure, Category = "Config | Messages")
     static FText GetCTScreenDeleteCharacterButtonText()
     {
          return FText::FromStringTable(*AssetPaths::UIStrings, TEXT("CTScreenDeleteCharacterButtonText"));
     }

     /** Returns the localized text for the "Select" message in the Characters Transition Screen. */
     UFUNCTION(BlueprintPure, Category = "Config | Messages")
     static FText GetCTScreenSelectCharacterButtonText()
     {
          return FText::FromStringTable(*AssetPaths::UIStrings, TEXT("CTScreenSelectCharacterButtonText"));
     }
};
